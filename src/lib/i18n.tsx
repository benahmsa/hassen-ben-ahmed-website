...
const dict = {
  ...
  pressIntro: {
    ...
    fr: "Articles et analyses que j'ai signés dans le journal tunisien « Al Bayane ».",
    en: "Articles and analyses I wrote for the Tunisian newspaper “Al Bayane”.",
  },
  articleLabel: { ar: "بقلمي", fr: "Signé", en: "By the author" },
